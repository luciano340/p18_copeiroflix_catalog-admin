...
from src.django_project.apps.video.views import VideoImageViewSet, VideoViewSet, VideoMediaViewSet
...
router.register(r'api/videos/upload_image', VideoImageViewSet, basename="upload_image")
